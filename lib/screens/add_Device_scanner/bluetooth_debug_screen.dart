    ...
    return Scaffold(
      ...
      body: Column(
        children: [
            ...
            child: Column(
              children: [
                ...
                Obx(() => CheckboxListTile(
                  title: Text(
                    'Show ALL Devices (Not just Minew)',
                    style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600),
                  ),
                  subtitle: Text(
                    controller.showAllDevices.value
                      ? 'Showing all nearby Bluetooth devices'
                      : 'Showing only Minew devices',
                    style: TextStyle(fontSize: 12),
                  ),
                  value: controller.showAllDevices.value,
                  onChanged: (value) {
                    controller.showAllDevices.value = value ?? false;
                    if (value == true) {
                      // Restart scan to apply filter
                  ...
                  tileColor: controller.showAllDevices.value
                    ? Colors.orange.withValues(alpha: 0.1)
                    : null,
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(8),
                    side: BorderSide(
                      color: controller.showAllDevices.value
                        ? Colors.orange
          ...
          // Device Count
          Obx(() {
            final deviceCount = controller.discoveredDevices.length;
            return Padding(
