                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TitledescriptionWidget(title: 'Description:', descreption: controller.productItem?.description ?? ''),
                                ],
                              ),
                            ),
                          ],
                  ...
                  : Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Gap(width: AppSize.width(value: 8)),
                              GetBuilder<AddToCartController>(builder: (addToCartCon) {
                                return Expanded(
                                    child: Obx(
                                  () => AppButton(
                                    ...
                                    title: "Add to Cart",
                                    onTap: () {
                                      addToCartCon.addToCart(quantity: controller.quantity.value, productId: controller.productItem!.sId!);
                                    },
                                  ),
                                ));
                              }),
                        ...
                        Padding(
                          ...
                          child: AppButton(
                            onTap: () {
                              Get.toNamed(AppRoutes.instance.deliveryDetainScreen, arguments: {
                                'products': controller.makeOrder,
                                'totalQuantity': controller.quantity.value,
                                'totalPrice': ((controller.productPrice) * (controller.quantity.value)),
                                "details": 'details'
                              });
                            },
                            isLoading: controller.isLoading.value,
