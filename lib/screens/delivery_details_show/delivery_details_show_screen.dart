            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  TextRowItem(text1: "Contact No", text2: "+963 932 509 736"),
                  TextRowItem(
                    text1: "Email",
                    text2: "asadujjamanmahfuz@gmail.com",
                  ),
                  TextRowItem(
                    text1: "Address",
                    text2: "P. O. Box 50332, Damasc...",
                  ),
                  TextRowItem(text1: "Note", text2: "N/A"),
                ],
              ),
            ),
            ...
            AppCard(
              child: Column(
                children: [
                  ...
                  TextRowItem(text1: "Product Quantity", text2: "1"),
                  AppDivider(),
                  TextRowItem(
                    text1: "Subtotal",
                    text2: "\$${16.30.toStringAsFixed(2)}",
                  ),
                  ...
                  AppDivider(),
                  TextRowItem(
                    text1: "Product Quantity",
                    text2: "\$${20.30.toStringAsFixed(2)}",
