...
import 'package:luggage_tracking/routes/bindings/terms_and_condition_binding.dart';
...
List<GetPage> appRootRoutesFile = <GetPage>[
  ...
  GetPage(
    ...
    binding: ProductCategoryScreenBinding(),
    page: () => const ProductCategoryScreen(),
  ),
  GetPage(
    name: AppRoutes.instance.allProductScreen,
