...
////////====================== BAse Screens===========================
  ...
  GetPage(name: AppRoutes.instance.deliveryDetainScreen, page: () => const DeliveryDetailsScreen()),
  GetPage(name: AppRoutes.instance.deliveryDetainShowScreen, page: () => const DeliveryDetailsShowScreen()),
