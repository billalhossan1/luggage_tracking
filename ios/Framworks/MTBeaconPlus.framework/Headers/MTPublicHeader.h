...
typedef NS_ENUM(NSInteger, FrameType) {
    ...
    FrameMBeaconInfo,
    FrameAltBeacon,
    FrameLongConnectBeacon,
    FrameBatteryLongConnectBeacon,  // 电量
    FrameSixAxisLongConnectBeacon,  // 六轴
    FrameClickTypeLongConnectBeacon,   // 按键
    
    FrameCombinationSensor,
};
