...
- (void)queryDevicesNameParameterWithCompletionHandler:(void(^)(BOOL isSuccess, NSString *name))completionHandler;

- (void)setDevicesName:(NSString *)nameStr CompletionHandler:(MTSensorResetOperatBlock)completionHandler;


- (void)setAccMeasuringRangeParameterWithWakeupThreshold:(NSInteger)wakeupThreshold WakeupDuration:(NSInteger)wakeupDuration CompletionHandler:(MTSensorResetOperatBlock)completionHandler;

- (void)queryAccMeasuringRangeParameterWithCompletionHandler:(void(^)(BOOL isSuccess, NSInteger wakeupThreshold, NSInteger wakeupDuration))completionHandler;
